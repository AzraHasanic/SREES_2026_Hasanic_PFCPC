...
//  Converter – MATPOWER .m  →  dTwin .dmodl  (polarne koordinate)
    ...
    DoneCb            doneCb)
{
    ...
    // Shunt admitancije iz bus podataka
    for (int i = 0; i < n; ++i) {
